...
<nav>
  ...
  <div class="nav-right">
    <a class="btn-outline" href="/auth" style="text-decoration:none">Sign In</a>
    <a class="btn-dark" href="/auth" style="text-decoration:none">Get Started</a>
  </div>
</nav>
...
<section class="hero">
  ...
  <div class="hero-inner">
    ...
    <div class="hero-actions">
      ...
      <a href="/auth" class="btn-hero-ghost">Go to Dashboard →</a>
    </div>
  ...
  <div class="cta-box">
    <div class="cta-content">
      ...
      <div class="email-row">
        ...
        <a href="/auth" class="btn-teal" style="text-decoration:none;display:inline-block">Get Started →</a>
      </div>
...
window.sendChat = async function() {
  ...
  try {
    // Calls the Supabase Edge Function — secrets live server-side, never in the browser
    ...
    const reply = data?.choices?.[0]?.message?.content
      || data?.reply
      || 'Sorry, I had trouble connecting. Please email streetwisesomatics@gmail.com.';
    if (!chatHistory) window.chatHistory = [];
    window.chatHistory = [...(window.chatHistory||[]), {role:'user',content:text},{role:'assistant',content:reply}];
    typingEl.remove();
