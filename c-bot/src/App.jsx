...
export default function Home() {
  useEffect(() => {
    ...
    const interactiveElements = document.querySelectorAll("a, button, .nav-item, .feat-card, .prob-card, .ds-ni");
    const handleHover = () => document.body.classList.add("h");
    const handleLeave = () => document.body.classList.remove("h");
    ...
    // 4. Hero Canvas Ambient Animation
    ...
    if (canvas) {
      ...
      const blobs = Array.from({ length: 4 }).map(() => ({
        ...
        color: Math.random() > 0.5 ? "rgba(0, 232, 154, 0.04)" : "rgba(59, 158, 255, 0.04)"
      }));
    ...
    // 5. Cleanup Phase (Critical for React Strict Mode)
    return () => {
...
@keyframes fadeUp{from{opacity:0;transform:translateY(44px)}to{opacity:1;transform:translateY(0)}}
      ...
      <nav id="nav">
        <a className="n-logo" href="#" style={{ gap: 0 }}>
          <img src="./ss.png" alt="SomaSyncAI" style={{ height: '38px', width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 8px rgba(59,158,255,0.4))' }} />
        </a>
      ...
      <section id="hero">
        ...
        <div className="hero-inner">
          ...
          <h1 className="hero-h1">THE <span className="out">GOLD</span><br /><span style={{ color: 'var(--blue)', textShadow: '0 0 80px var(--blue-glow)' }}>STANDARD</span><br />CLINICAL <span className="out">OS</span></h1>
          <div style={{ marginTop: '24px', fontFamily: "'Syne', sans-serif", fontSize: 'clamp(.9rem,1.5vw,1.2rem)', fontWeight: 700, letterSpacing: '.04em', color: 'var(--muted)', opacity: 0, animation: 'fadeUp .8s .7s forwards' }}>The Intelligence of You.</div>
        </div>
          ...
          <div className="dash-screen">
            ...
            <div className="dash-body">
              ...
              <div className="dash-main">
                ...
                <div style={{ display: 'flex', gap: 0, marginBottom: '20px', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '10px', overflow: 'hidden' }}>
                  <div style={{ flex: 1, padding: '10px 12px', background: 'rgba(0,232,154,0.12)', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}>
                    <div style={{ fontSize: '.55rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>✓ Intake</div>
                  </div>
                  <div style={{ flex: 1, padding: '10px 12px', background: 'rgba(0,232,154,0.08)', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}>
                    <div style={{ fontSize: '.55rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>● Calibration</div>
                  </div>
                  <div style={{ flex: 1, padding: '10px 12px', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center', opacity: 0.35 }}>
                    <div style={{ fontSize: '.55rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)' }}>Analysis</div>
                  </div>
                  <div style={{ flex: 1, padding: '10px 12px', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center', opacity: 0.35 }}>
                    <div style={{ fontSize: '.55rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)' }}>Assessment</div>
                  </div>
                  <div style={{ flex: 1, padding: '10px 12px', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center', opacity: 0.35 }}>
                    <div style={{ fontSize: '.55rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)' }}>Generate</div>
                  </div>
                  <div style={{ flex: 1, padding: '10px 12px', textAlign: 'center', opacity: 0.35 }}>
                    <div style={{ fontSize: '.55rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)' }}>Live Session</div>
                  </div>
                </div>
                {/* Calibration + Consent panel */}
                <div className="aa-box" style={{ marginBottom: '16px' }}>
                  <div className="aa-av">🔒</div>
                  <div style={{ flex: 1 }}>
                    <div className="aa-l">Consent — Required Before Calibration</div>
                    <div className="aa-t" style={{ marginBottom: '10px' }}>AALIYAH will listen and process voice during this session. Client consent is required and logged.</div>
                    <div style={{ display: 'flex', gap: '8px' }}>
                      <div style={{ background: 'var(--grn)', color: '#080808', fontSize: '.65rem', fontWeight: 700, padding: '6px 14px', borderRadius: '100px', letterSpacing: '.06em' }}>✓ Consent Given</div>
                      <div style={{ background: 'rgba(255,255,255,0.06)', color: 'var(--muted)', fontSize: '.65rem', fontWeight: 700, padding: '6px 14px', borderRadius: '100px', letterSpacing: '.06em' }}>View Policy</div>
                    </div>
                  </div>
                </div>
                <div className="aa-box">
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div className="aa-t" style={{ marginBottom: '10px' }}>Say the following phrase clearly: <b>"AALIYAH, begin session for Sarah Mitchell."</b> Calibrating to your voice in current environment.</div>
                    <div className="waveform" id="wf1" style={{ marginTop: 0, height: '32px', border: 'none', background: 'transparent', padding: 0 }}></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="ds-sec">
        ...
        <div className="ds-wrap rv">
          ...
          <div className="ds-screen">
            <div className="ds-bar2"><div className="dash-dots"><div className="dash-dot dd1"></div><div className="dash-dot dd2"></div><div className="dash-dot dd3"></div></div><div className="dash-url" style={{ maxWidth: '300px' }}>app.somasyncai.com/dashboard</div></div>
            <div className="ds-inner">
              ...
              <div className="ds-center">
                ...
                {/* Step progress */}
                <div style={{ display: 'flex', gap: 0, marginBottom: '22px', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '10px', overflow: 'hidden' }}>
                  <div style={{ flex: 1, padding: '9px 10px', background: 'rgba(0,232,154,0.1)', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}><div style={{ fontSize: '.52rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--grn)' }}>✓ Intake</div></div>
                  <div style={{ flex: 1, padding: '9px 10px', background: 'rgba(0,232,154,0.1)', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}><div style={{ fontSize: '.52rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--grn)' }}>✓ Calibration</div></div>
                  <div style={{ flex: 1, padding: '9px 10px', background: 'rgba(0,232,154,0.14)', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center' }}><div style={{ fontSize: '.52rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--grn)' }}>● Analysis</div></div>
                  <div style={{ flex: 1, padding: '9px 10px', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center', opacity: 0.3 }}><div style={{ fontSize: '.52rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--muted)' }}>Assessment</div></div>
                  <div style={{ flex: 1, padding: '9px 10px', borderRight: '1px solid rgba(255,255,255,0.07)', textAlign: 'center', opacity: 0.3 }}><div style={{ fontSize: '.52rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--muted)' }}>Generate</div></div>
                  <div style={{ flex: 1, padding: '9px 10px', textAlign: 'center', opacity: 0.3 }}><div style={{ fontSize: '.52rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--muted)' }}>Live Session</div></div>
                </div>
                <div className="ds-sg">
                  ...
                  <div className="ds-sc" style={{ background: 'rgba(255,80,80,0.04)', borderColor: 'rgba(255,100,100,0.2)' }}><div className="ds-sl" style={{ color: '#ff8080' }}>⚠ Contraindication Check</div><div className="ds-st">Hypertension noted — <b>avoid aggressive cervical manipulation.</b> AALIYAH flagged: confirm BP before session.</div></div>
                  <div className="ds-sc" style={{ background: 'rgba(0,232,154,0.04)', borderColor: 'rgba(0,232,154,0.18)' }}><div className="ds-sl">AALIYAH Recommends</div><div className="ds-st">Perform <b>cervical orthopedic tests:</b> Spurling's, distraction, Valsalva. Check dermatomal patterns before bodywork.</div></div>
                </div>
      ...
      <section id="how" className="sec">
        ...
        <div className="how-grid" style={{ gridTemplateColumns: 'repeat(3,1fr)', marginTop: '60px' }}>
          <div className="how-card rv d1">
            ...
            <div style={{ marginTop: '16px', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>Intake & Preparation</div>
          </div>
          <div className="how-card rv d2">
            ...
            <div style={{ marginTop: '16px', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>Calibration & Consent</div>
          </div>
          <div className="how-card rv d3">
            ...
            <div style={{ marginTop: '16px', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>Clinical Analysis</div>
          </div>
          <div className="how-card rv d1" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ marginTop: '16px', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>Visual & Postural Assessment</div>
          </div>
          <div className="how-card rv d2" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ marginTop: '16px', display: 'inline-flex', alignItems: 'center', gap: '7px', background: 'rgba(0,232,154,0.1)', border: '1px solid rgba(0,232,154,0.25)', color: 'var(--grn)', fontSize: '.62rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', padding: '5px 14px', borderRadius: '100px' }}>⚡ Generate Documentation</div>
          </div>
          <div className="how-card rv d3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div style={{ marginTop: '16px', fontSize: '.65rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--grn)' }}>Live Treatment Session</div>
          </div>
        </div>
      </section>
      ...
      {/* ══ COMING SOON ══ */}
      <section id="coming" className="sec" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.06)', marginTop: '60px' }}>
          <div className="feat-card rv d1" style={{ gridColumn: 'span 1' }}>
            ...
            <div style={{ marginTop: '16px', fontSize: '.62rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)', border: '1px solid rgba(255,255,255,0.1)', padding: '5px 12px', borderRadius: '100px', display: 'inline-block' }}>Coming Q3 2026</div>
          </div>
          ...
          <div className="feat-card rv d3">
            ...
            <div style={{ marginTop: '16px', fontSize: '.62rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)', border: '1px solid rgba(255,255,255,0.1)', padding: '5px 12px', borderRadius: '100px', display: 'inline-block' }}>Coming Q4 2026</div>
          </div>
          <div className="feat-card feat-row2 rv d1">
            ...
            <div style={{ marginTop: '16px', fontSize: '.62rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)', border: '1px solid rgba(255,255,255,0.1)', padding: '5px 12px', borderRadius: '100px', display: 'inline-block' }}>Coming 2027</div>
          </div>
          ...
          <div className="feat-card feat-row2 rv d3">
            ...
            <div style={{ marginTop: '16px', fontSize: '.62rem', fontWeight: 700, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--muted)', border: '1px solid rgba(255,255,255,0.1)', padding: '5px 12px', borderRadius: '100px', display: 'inline-block' }}>The Full Vision</div>
          </div>
        </div>
      </section>

      {/* ══ DISCIPLINES ══ */}
      <section id="who" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(80px,10vw,140px) var(--r)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '1px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.06)', marginTop: '60px' }}>
          <div className="feat-card rv d1" style={{ padding: '52px 44px' }}>
            <div style={{ fontSize: '2rem', marginBottom: '20px' }}>💆</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Massage Therapists</div>
          ...
          <div className="feat-card rv d2" style={{ padding: '52px 44px' }}>
            <div style={{ fontSize: '2rem', marginBottom: '20px' }}>🏃</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Physical Therapists</div>
          ...
          <div className="feat-card rv d3" style={{ padding: '52px 44px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '2rem', marginBottom: '20px' }}>🦴</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Chiropractors</div>
          ...
          <div className="feat-card rv d4" style={{ padding: '52px 44px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '2rem', marginBottom: '20px' }}>⚽</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Sports Medicine & Athletic Trainers</div>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '56px var(--r)', background: 'rgba(255,255,255,0.015)' }}>
        <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.18em', textTransform: 'uppercase', color: 'rgba(240,237,232,0.25)', textAlign: 'center', marginBottom: '40px' }}>Aligned With Leading Medical & Academic Institutions</div>
        <div style={{ overflow: 'hidden', position: 'relative' }}>
          <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: '120px', background: 'linear-gradient(to right,#080808,transparent)', zIndex: 2, pointerEvents: 'none' }}></div>
          <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: '120px', background: 'linear-gradient(to left,#080808,transparent)', zIndex: 2, pointerEvents: 'none' }}></div>
          <div className="logo-track" style={{ display: 'flex', alignItems: 'center', width: 'max-content', animation: 'march 40s linear infinite', gap: 0 }}>
            
            {/* Logos */}
            {[
              "STANFORD|MEDICINE", "JOHNS HOPKINS|MEDICINE", "MAYO|CLINIC", "UCSF|HEALTH",
              "APTA|AMERICAN PT ASSOC.", "AMTA|MASSAGE THERAPY ASSOC.", "ACA|CHIROPRACTIC ASSOC.", "HIPAA|COMPLIANT",
              "STANFORD|MEDICINE", "JOHNS HOPKINS|MEDICINE", "MAYO|CLINIC", "UCSF|HEALTH",
              "APTA|AMERICAN PT ASSOC.", "AMTA|MASSAGE THERAPY ASSOC.", "ACA|CHIROPRACTIC ASSOC.", "HIPAA|COMPLIANT"
            ].map((text, i) => {
              const [top, bottom] = text.split('|');
              return (
                <div key={i} className="logo-slot" style={{ padding: '0 48px', display: 'flex', alignItems: 'center', flexShrink: 0, opacity: 0.45, transition: 'opacity .2s' }} onMouseEnter={(e) => e.currentTarget.style.opacity = '0.9'} onMouseLeave={(e) => e.currentTarget.style.opacity = '0.45'}>
                  <span style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '.88rem', letterSpacing: '.04em', color: '#fff', whiteSpace: 'nowrap' }}>
                    {top}<br /><span style={{ fontWeight: 400, fontSize: '.72rem', letterSpacing: '.1em', opacity: 0.6 }}>{bottom}</span>
                  </span>
                </div>
              );
            })}
      ...
      {/* ══ TESTIMONIAL ══ */}
      <section style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(80px,10vw,140px) var(--r)', background: 'rgba(255,255,255,0.015)' }}>
        <div className="sec-tag rv">Early Access Feedback</div>
        <div className="rv d1" style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 'clamp(1.6rem,3.5vw,3rem)', lineHeight: 1.15, letterSpacing: '-.03em', maxWidth: '900px', margin: '36px 0 20px', borderLeft: '3px solid var(--grn)', paddingLeft: '32px' }}>"I finished my last patient and my notes were already done. For the first time in 12 years of practice, I left on time."</div>
        <div className="rv d2" style={{ fontSize: '.88rem', color: 'var(--muted)', paddingLeft: '35px' }}>Beta Practitioner — Physical Therapist, California</div>
      </section>

      {/* ══ CALIFORNIA LOCATIONS ══ */}
      <section style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(80px,10vw,140px) var(--r)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '40px', marginTop: '60px' }}>
          <div className="rv d1">
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '16px' }}>Central Valley</div>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Fresno, CA</strong>Physical therapy & chiropractic</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Bakersfield, CA</strong>Manual therapy & sports medicine</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Stockton, CA</strong>Massage therapy & rehabilitation</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Modesto, CA</strong>Chiropractic & wellness</li>
            </ul>
          </div>
          <div className="rv d2">
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '16px' }}>Los Angeles Region</div>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Los Angeles, CA</strong>Manual therapy & sports medicine</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Long Beach, CA</strong>Physical therapy & chiropractic</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Pasadena, CA</strong>Sports medicine & PT</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Glendale, CA</strong>Massage therapy & wellness</li>
            </ul>
          </div>
          <div className="rv d3">
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '16px' }}>Bay Area</div>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>San Francisco, CA</strong>Physical therapy & chiropractic</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>San Jose, CA</strong>Sports medicine & PT</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Oakland, CA</strong>Massage therapy & rehab</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Palo Alto, CA</strong>Clinical AI & sports medicine</li>
            </ul>
          </div>
          <div className="rv d4">
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '16px' }}>Sacramento & Beyond</div>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Sacramento, CA</strong>Rehabilitation & chiropractic</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>San Diego, CA</strong>Athletic training & massage</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>New York, NY</strong>Multi-discipline practices</li>
              <li style={{ fontSize: '.88rem', color: 'var(--muted)' }}><strong style={{ color: 'var(--ink)', display: 'block', fontSize: '.88rem' }}>Chicago, IL</strong>Sports & orthopedic therapy</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      {/* ══ FREE EBOOKS ══ */}
      <section id="ebooks" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(80px,10vw,140px) var(--r)' }}>
        <div className="sec-tag rv">Free Resources</div>
        <h2 className="sec-h rv d1">FREE CLINICAL<br /><span className="g">LIBRARY</span></h2>
        <p style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--muted)', maxWidth: '500px', marginTop: '20px', marginBottom: '60px' }} className="rv d2">Gold standard references for every manual therapist — free to download. No email required.</p>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '16px' }}>
          {[
            { tag: "Manual Therapy", title: "Handbook of Massage Therapy", desc: "Emil Scheider's comprehensive reference covering massage techniques, protocols, and clinical applications for manual therapists.", link: "https://drive.google.com/file/d/1_e4YjvFsmpocpoJIdsmOtuILvUeG7ep7/view?usp=drivesdk" },
            { tag: "Chinese Medicine", title: "TCM Clinical Integration", desc: "Traditional Chinese Medicine principles applied to manual therapy practice — meridians, TCM patterns, and clinical integration.", link: "https://drive.google.com/file/d/1Y5dbHmhOwi2tsu3J9C-NRwQFaPdufW_H/view?usp=drivesdk" },
            { tag: "Orthopedic Manual Therapy", title: "Orthopedic Assessment", desc: "Orthopedic assessment and treatment protocols for manual therapists — joint mechanics, special tests, and evidence-based interventions.", link: "https://drive.google.com/file/d/1dcVmz-91bSgK0MsmiQ4RgsGoPQUb877J/view?usp=drivesdk" },
            { tag: "Anatomy Reference", title: "Clinical Anatomy", desc: "Clinical anatomy reference for hands-on practitioners — musculoskeletal structures, nerve pathways, and palpation landmarks.", link: "https://drive.google.com/file/d/1fSaVCEKT-Y7UYIsqFfBUCtoMnlYxzUih/view?usp=drivesdk" },
            { tag: "Manual Therapy", title: "Soft Tissue Protocols", desc: "Essential manual therapy reference covering soft tissue techniques, joint mobilisation, and clinical reasoning frameworks.", link: "https://drive.google.com/file/d/16T4mgR8Z0twnoxbzAdQdFmVJYNlVkoIS/view?usp=drivesdk" },
            { tag: "Chinese Medicine", title: "Advanced TCM Protocols", desc: "Advanced TCM clinical protocols for bodywork practitioners — acupuncture points, five element theory, and treatment strategies.", link: "https://drive.google.com/file/d/1O4wxECMZ4fKQF01wQAjZS2Jz5IOyGLry/view?usp=drivesdk" },
            { tag: "Anatomy Reference", title: "Netter's Atlas of Human Anatomy", desc: "The gold standard anatomical atlas for clinical practitioners — Frank Netter's legendary illustrations of musculoskeletal, nervous, and vascular systems.", link: "https://drive.google.com/file/d/1pQ3-f91zNkBB5tcmdJB7ZBBADapcL2D1/view?usp=drivesdk" },
            { tag: "Orthopedic Manual Therapy", title: "Maitland & Mulligan Approaches", desc: "Orthopedic manual therapy techniques — Maitland, Mulligan, and McKenzie approaches with clinical decision-making frameworks.", link: "https://drive.google.com/file/d/1T7sgcTXZYIb4XPm_WAgalWxhjCWEiksy/view?usp=drivesdk" },
            { tag: "Manual Therapy Protocols", title: "Integrative Protocols", desc: "Advanced manual therapy protocols integrating Western and Eastern approaches for complex musculoskeletal presentations.", link: "https://drive.google.com/file/d/1VvL3wVqm7Z4KVeJUhVVFSvkVxALoNVQP/view?usp=drivesdk" },
          ].map((book, i) => (
            <a key={i} href={book.link} target="_blank" className={`rv d${(i % 3) + 1}`}
              style={{ display: 'block', textDecoration: 'none', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '32px 28px', position: 'relative', overflow: 'hidden', transition: 'background .25s,border-color .25s', cursor: 'pointer' }}
              onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(0,232,154,0.05)'; e.currentTarget.style.borderColor = 'rgba(0,232,154,0.25)'; }}
              ...
              <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.6rem', fontWeight: 700, letterSpacing: '.12em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '8px' }}>{book.tag}</div>
              <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '.98rem', letterSpacing: '-.01em', color: '#fff', marginBottom: '10px', lineHeight: 1.3 }}>{book.title}</div>
              <div style={{ fontSize: '.78rem', lineHeight: 1.6, color: 'var(--muted)', marginBottom: '20px' }}>{book.desc}</div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: "'Syne', sans-serif", fontSize: '.7rem', fontWeight: 700, letterSpacing: '.08em', textTransform: 'uppercase', color: 'var(--grn)' }}>⬇ Download Free</div>
            </a>
          ))}
        </div>
        <div style={{ textAlign: 'center', marginTop: '20px', fontSize: '.76rem', color: 'var(--muted)' }}>All resources free to download. No email. No paywall. Just knowledge.</div>
      </section>

      {/* ══ TEAM ══ */}
      <section id="team" style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: 'clamp(80px,10vw,140px) var(--r)' }}>
        ...
        <p style={{ fontSize: '1rem', lineHeight: 1.8, color: 'var(--muted)', maxWidth: '460px', marginTop: '20px' }} className="rv d2">We're looking for rare people who see the full vision and want to help build it from the ground up.</p>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '1px', background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.06)', marginTop: '60px' }}>
          <div className="feat-card rv d1" style={{ padding: '52px 44px' }}>
            <div style={{ fontSize: '1.8rem', marginBottom: '20px' }}>🤝</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '8px' }}>Co-Founder</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Build This With Me</div>
            <div className="feat-desc" style={{ marginBottom: '24px' }}>Looking for a co-founder who is obsessed with healthcare technology, understands the manual therapy space, and wants to own a significant piece of something that could change how 1.2 million practitioners work every day.</div>
            <a href="/cdn-cgi/l/email-protection#5e363b3232311e2d31333f2d27303d3f37703d3133612d2b3c343b3d2a631d317318312b303a3b2c7e17302f2b372c27" style={{ fontFamily: "'Syne', sans-serif", fontSize: '.8rem', fontWeight: 700, color: 'var(--grn)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>Get In Touch →</a>
          </div>
          <div className="feat-card rv d2" style={{ padding: '52px 44px' }}>
            <div style={{ fontSize: '1.8rem', marginBottom: '20px' }}>💰</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '8px' }}>Investor</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Seed Round Open</div>
            <div className="feat-desc" style={{ marginBottom: '24px' }}>We are raising a $2.5M seed round. Live MVP. Real beta users. A $28B addressable market with no purpose-built real-time solution. If you invest in healthcare AI at the seed stage, let's talk.</div>
            <a href="https://somasyncai.com/investor-pitch" style={{ fontFamily: "'Syne', sans-serif", fontSize: '.8rem', fontWeight: 700, color: 'var(--grn)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>View Pitch Deck →</a>
          </div>
          <div className="feat-card rv d3" style={{ padding: '52px 44px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '1.8rem', marginBottom: '20px' }}>⚙️</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '8px' }}>Engineer / Developer</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Build the Infrastructure</div>
            <div className="feat-desc" style={{ marginBottom: '24px' }}>We need engineers excited about real-time AI, voice processing, and healthcare infrastructure. React, Node, Supabase, voice AI. Build something that genuinely matters in people's working lives.</div>
            <a href="/cdn-cgi/l/email-protection#adc5c8c1c1c2eddec2c0ccded4c3ceccc483cec2c092ded8cfc7c8ced990e8c3cac4c3c8c8df8de4c3dcd8c4dfd4" style={{ fontFamily: "'Syne', sans-serif", fontSize: '.8rem', fontWeight: 700, color: 'var(--grn)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>Get In Touch →</a>
          </div>
          <div className="feat-card rv d4" style={{ padding: '52px 44px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '1.8rem', marginBottom: '20px' }}>🔬</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '.65rem', fontWeight: 700, letterSpacing: '.14em', textTransform: 'uppercase', color: 'var(--grn)', marginBottom: '8px' }}>Data Researcher</div>
            <div className="feat-title" style={{ fontSize: '1.2rem', marginBottom: '12px' }}>Shape the Intelligence Layer</div>
            <div className="feat-desc" style={{ marginBottom: '24px' }}>SomaSphere and Predictive Care are built on population-level clinical data. We need researchers with backgrounds in clinical NLP, musculoskeletal data, or healthcare AI who want to define what that intelligence layer looks like.</div>
            <a href="/cdn-cgi/l/email-protection#e189848d8d8ea1928e8c8092988f828088cf828e8cde9294838b848295dca5809580c1b3849284809382898493c1a88f9094889398" style={{ fontFamily: "'Syne', sans-serif", fontSize: '.8rem', fontWeight: 700, color: 'var(--grn)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>Get In Touch →</a>
          </div>
        </div>
        <div style={{ marginTop: '32px', textAlign: 'center', fontSize: '.84rem', color: 'var(--muted)' }}>Don't fit neatly into a box but feel the pull? <a href="/cdn-cgi/l/email-protection#0169646d6d6e41726e6c6072786f6260682f626e6c3e7274636b6462753c46646f6473606d21486f7074687378" style={{ color: 'var(--grn)', textDecoration: 'none' }}>Reach out anyway →</a></div>
      </section>
      ...
      <section id="cta">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.08)', maxWidth: '860px', margin: '0 auto 48px', borderRadius: '12px', overflow: 'hidden' }} className="rv d2">
          <div style={{ padding: '28px 24px', background: 'rgba(255,255,255,0.03)', textAlign: 'center' }}>
            <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '2rem', color: 'var(--grn)', marginBottom: '8px' }}>01</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '.88rem', marginBottom: '8px' }}>Use SomaSyncAI</div>
            <div style={{ fontSize: '.78rem', lineHeight: 1.6, color: 'var(--muted)' }}>Join beta. Use it in your practice. Experience the difference hands-free documentation makes.</div>
          </div>
          <div style={{ padding: '28px 24px', background: 'rgba(255,255,255,0.03)', textAlign: 'center', borderLeft: '1px solid rgba(255,255,255,0.08)', borderRight: '1px solid rgba(255,255,255,0.08)' }}>
            <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '2rem', color: 'var(--grn)', marginBottom: '8px' }}>02</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '.88rem', marginBottom: '8px' }}>Give Feedback</div>
            <div style={{ fontSize: '.78rem', lineHeight: 1.6, color: 'var(--muted)' }}>Share honest feedback on what works, what doesn't, and what you wish it could do.</div>
          </div>
          <div style={{ padding: '28px 24px', background: 'rgba(255,255,255,0.03)', textAlign: 'center' }}>
            <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '2rem', color: 'var(--grn)', marginBottom: '8px' }}>03</div>
            <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '.88rem', marginBottom: '8px' }}>Refer One Therapist</div>
            <div style={{ fontSize: '.78rem', lineHeight: 1.6, color: 'var(--muted)' }}>Refer one colleague who beta tests, gives feedback, and refers someone too. Everyone who completes all 3 gets lifetime free access — no exceptions, no expiry.</div>
          </div>
        </div>
      ...
      <footer>
        <div className="foot-top">
          <div>
            <div className="foot-brand" style={{ marginBottom: '16px' }}><img src="./ss.png" alt="SomaSyncAI" style={{ height: '44px', width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 0 10px rgba(59,158,255,0.35))' }} /></div>
