...
const TherapistDashboard = () => {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      {/* Welcome Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-foreground mb-2">Therapist Command Center</h1>
        <p className="text-muted-foreground">
          Welcome back, {profile?.fullName?.split(" ")[0] || "Doctor"}. Manage your practice with
          ΛΛLIYΛH.IO compliance protection.
        </p>
      </div>
      ...
      {!hasPro && (
        <Card className="mb-8 border-2 border-soma-purple bg-gradient-to-r from-soma-purple-light to-background">
          <CardContent className="flex items-center justify-between p-6">
            ...
            <Button className="bg-soma-purple hover:bg-soma-purple/90">Upgrade to Pro - $49/mo</Button>
          </CardContent>
        </Card>
      )}
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="hover:shadow-lg transition-shadow border-2 hover:border-primary/50">
          <CardHeader>
            ...
            <CardDescription>Get clinical guidance with Oxford terminology and Travell patterns</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className={`hover:shadow-lg transition-shadow border-2 ${!hasPro ? "border-dashed" : "hover:border-primary/50"}`}>
          <CardHeader>
            ...
            <CardDescription>Dictate raw notes and get insurance-ready SOAP documentation</CardDescription>
          </CardHeader>
          <CardContent>
            {hasPro ? (
        ...
        <Card className={`hover:shadow-lg transition-shadow border-2 ${!hasPro ? "border-dashed" : "hover:border-primary/50"}`}>
          <CardHeader>
            ...
            <CardDescription>Search waivers and consent forms by modality (Deep Tissue, Cupping, etc.)</CardDescription>
          </CardHeader>
          <CardContent>
            {hasPro ? (
              <Button asChild variant="secondary" className="w-full">
        ...
        <Card className="hover:shadow-lg transition-shadow border-2 opacity-50 pointer-events-none">
          <CardHeader>
            ...
            <CardDescription>276 mobilization techniques with Oxford references</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild variant="secondary" className="w-full">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="bg-gradient-to-br from-soma-blue-light to-background">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              C-Bot is your compliance partner, ensuring all documentation meets legal standards and stays within your scope of practice.
            </p>
        ...
        <Card className="bg-gradient-to-br from-soma-orange-light to-background">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-muted-foreground">
              ΛΛLIYΛH.IO monitors your documentation for techniques that may fall outside your license type. Examples of flagged activities:
            </p>
