...
// multer and /api/v1/voice retained: SoapGenerator.jsx still uses REST transcription path.
// Re-enable when voice.ts is fully retired and dashboard migrated to WSS path.
