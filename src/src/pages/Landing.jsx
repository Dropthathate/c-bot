      ...
      <section style={{ padding: "64px 32px", background: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ fontSize: 12, color: "#6e6e73", lineHeight: 1.85, background: "#f5f5f7", borderRadius: 14, padding: "24px 28px" }}>
            <strong>AI-Generated Content:</strong> All documentation produced by SomaSync AI is generated by artificial intelligence and may contain errors. All outputs must be reviewed by a licensed clinician before use.{" "}
...
const s = {
  ...
  nav: { position: "sticky", top: 0, zIndex: 100, height: 54, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 32px", background: "rgba(255,255,255,0.88)", backdropFilter: "saturate(180%) blur(24px)", borderBottom: "0.5px solid rgba(0,0,0,0.1)" },
  ...
  heroMesh: { position: "absolute", inset: 0, background: "radial-gradient(ellipse 70% 60% at 50% -5%,rgba(48,217,192,0.14) 0%,transparent 65%),radial-gradient(ellipse 50% 50% at 85% 50%,rgba(10,132,255,0.08) 0%,transparent 55%)" },
  heroInner: { position: "relative", zIndex: 1, maxWidth: 820 },
  eyebrow: { display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.9)", border: "1px solid rgba(48,217,192,0.3)", borderRadius: 980, padding: "6px 16px", fontSize: 12, fontWeight: 600, color: "#0aab94", letterSpacing: "0.03em", textTransform: "uppercase", marginBottom: 36 },
  ...
  btnHero: { background: "#1d1d1f", color: "#fff", textDecoration: "none", padding: "16px 32px", borderRadius: 980, fontSize: 16, fontWeight: 600, letterSpacing: "-0.02em", display: "inline-flex", alignItems: "center", gap: 8 },
  ...
  tag: { display: "inline-block", fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "#0aab94", background: "rgba(48,217,192,0.1)", padding: "5px 12px", borderRadius: 980, marginBottom: 16 },
  ...
  accessNotice: { fontSize: 12, color: "#c47800", background: "rgba(255,159,10,0.08)", border: "1px solid rgba(255,159,10,0.2)", borderRadius: 10, padding: "12px 14px", marginBottom: 16, lineHeight: 1.6 },
  btnAccess: { width: "100%", background: "#1d1d1f", color: "#fff", border: "none", padding: 14, borderRadius: 12, fontSize: 15, fontWeight: 700, fontFamily: "inherit", cursor: "pointer", marginTop: 4 },
