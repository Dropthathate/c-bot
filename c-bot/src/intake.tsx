...
export const IntakePage = () => {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto font-sans">
      ...
      <button type="button" className="mt-8 w-full py-5 bg-black text-white text-xs font-bold uppercase tracking-[0.3em] rounded-full hover:bg-blue-600 transition-colors">
